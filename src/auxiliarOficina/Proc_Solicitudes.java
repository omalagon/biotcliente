...
import administrador.Reportes.itemxProveedor;
...
public class Proc_Solicitudes extends javax.swing.JFrame {
    ...
    public Proc_Solicitudes(BigDecimal id) {
        initComponents();
    ...
    private void BotonCotizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonCotizarActionPerformed
        ...
        Cotizacion c = null;
        try {
            c = new Cotizacion(Proc_Solicitudes.id, numSol.toString(), fecha, solicitud_NumSol.getArea(), solicitud_NumSol.getNombreRA(), items_numSol, solicitud_NumSol.getObservaciones());
        } catch (RemoteException ex) {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        VentanaInicio_AO v = new VentanaInicio_AO(id.toString());
        v.setVisible(true);
        this.setVisible(false);
