...
public class Cotizacion extends javax.swing.JFrame {
    ...
    Cotizacion(BigDecimal id, String toString, GregorianCalendar fecha, String area, String nombreRA, ArrayList<ItemInventario> items_numSol, String observaciones) throws RemoteException {
        initComponents();
    ...
    private void BotonRevisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonRevisarActionPerformed
        ...
        for (int ite : itemsAct) {
            ...
            try {
                ...
                ArrayList<ItemInventario> itemxProv = u.itemxProv(proveedor);
                for (ItemInventario i : itemxProv) {
                    ...
                    {
                        u.asociarItem(codigo, proveedor, lab, Float.toString(precio));
