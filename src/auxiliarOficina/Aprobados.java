...
public class Aprobados extends javax.swing.JFrame {
    ...
    public Aprobados(BigDecimal id) {
        initComponents();
        Aprobados.id = id;
    ...
    private void btnRealizarOrdenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRealizarOrdenActionPerformed
        ...
        System.out.println(this.Apro_NITProv.getSelectedItem());
        ...
        try {
            ...
            if (prov != null) {
                p = new proveedor(prov.getNombre(), prov.getNIT(), prov.getDireccion(), prov.getTelefono(), prov.getTelefax(), prov.getCelular(), prov.getCorreo());
    ...
    private void btnRealizarOrden1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRealizarOrden1ActionPerformed
        VentanaInicio_AO vent = new VentanaInicio_AO(Aprobados.id.toString());
