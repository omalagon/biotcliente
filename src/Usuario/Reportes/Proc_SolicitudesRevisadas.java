...
public class Proc_SolicitudesRevisadas extends javax.swing.JFrame {
    ...
    public Proc_SolicitudesRevisadas(String id) throws RemoteException {
        ...
        solNoRev = (ArrayList<SolicitudPr>) getSolicitudes("", id);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        sol.setIdAO(id);
        desaprobarItems = desaprobarItems(itemsAprobados, sol, arrProv);
        if (desaprobarItems) {
    ...
    private void btnGenerarFDC001ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGenerarFDC001ActionPerformed
        ...
        if (numSol != null) {
            ...
            File archivo = fdc001.metodo(path, parametros, EstructurasAux.ItemInventario.toObjectArray(this.arrAux(items_numSol), proveedores, cantAprobada));
    ...
    private void llenarContenidoSol(BigDecimal numsol) throws RemoteException {
        ...
        if (!itemsXSolicitud.isEmpty()) {
            ...
            for (ItemInventario i : itemsXSolicitud) {
                ...
                Itemxproveedor itxp = new Itemxproveedor();
                itxp.setNombre("");
                itxp.setPrecio(i.getPrecio());
                itxp.setCinterno(i.getNumero());
                datos[7] = getProveedorAsociado(itxp).get(0).getNombre();
    ...
    private static boolean desaprobarItems(java.util.List<logica.ItemInventario> items, logica.SolicitudPr sol, java.util.List<java.lang.String> proveedor) {
        logica.LogicaBiotrends_Service service = new logica.LogicaBiotrends_Service();
        logica.LogicaBiotrends port = service.getLogicaBiotrendsPort();
        return port.desaprobarItems(items, sol, proveedor);
    }
    ...
    private static Users getDatosUsuario_1(java.lang.String id) {
        logica.LogicaBiotrends_Service service = new logica.LogicaBiotrends_Service();
        logica.LogicaBiotrends port = service.getLogicaBiotrendsPort();
        return port.getDatosUsuario(id);
    }

    private static Users getDatosUsuario_2(java.lang.String id) {
        logica.LogicaBiotrends_Service service = new logica.LogicaBiotrends_Service();
        logica.LogicaBiotrends port = service.getLogicaBiotrendsPort();
        return port.getDatosUsuario(id);
    }
