...
public class itemxProveedor extends javax.swing.JFrame {
    ...
    private void llenarTablaIXP(String nit) {
        ...
        tablaCotizacionesIXP = (ArrayList<ItemInventario>) itemxProv(nit);
    ...
    private static java.util.List<logica.ItemInventario> itemxProv(java.lang.String nit) {
        logica.LogicaBiotrends_Service service = new logica.LogicaBiotrends_Service();
        logica.LogicaBiotrends port = service.getLogicaBiotrendsPort();
        return port.itemxProv(nit);
    }
}
